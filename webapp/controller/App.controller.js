  ...
  function (BaseController, Filter, FilterOperator, MessageBox, JSONModel) {
    ...
    return BaseController.extend("br.com.idxtec.ui5Template.controller.App", {
      onInit: function () {
        ...
        let oJSONModel = new JSONModel(this.getDataMock());
      ...
      _routerMatch: function() {
        ...
        oJSONModel.setData(this.getData());
      },
      ...
      onSearch: function (oEvent) {
        ...
        let oFilterLastName = new Filter(
          "LastName",
          FilterOperator.Contains,
          sQuery
        );
        let oFilterFirstName = new Filter(
          "FirstName",
          FilterOperator.Contains,
          sQuery
        );
        let oFilter = new Filter({
          filters: [oFilterLastName, oFilterFirstName],
          and: false,
        });
      ...
      _msgConfirmDelete: function () {
        return new Promise((resolve) => {
          MessageBox.confirm(
            this.getBundle().getText("AppController.ConfirmDelete"),
            {
              onClose: (sAction) => {
                resolve(sAction);
              },
